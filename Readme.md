<h2>MAISec - приложения для воспроизведения веб-уязвимостей
...
Патченная версия приложения "банк". Во все POST-запросы добавлен токен CSRF (защита с помощью токена синхронизации).
